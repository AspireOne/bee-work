...
var mongodbPassword = process.env.MONGODB_PASSWORD; // Works.
...
function findMovie() {
    return __awaiter(this, void 0, void 0, function () {
        var movie, client, database, movies, query;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    movie = null;
                    client = new mongodb_1.MongoClient(uri, { serverApi: mongodb_1.ServerApiVersion.v1 });
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, , 4, 6]);
