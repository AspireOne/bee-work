...
var handler = function (event, context) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent(); // Async await v javascriptu je v tom případě úplně zbytečnej. Neblokuje main thread, což je super duper, ale nemůžu actually programovat asynchronně a v node.js je to úplně zbytečné. Píčovina.
                database = client.db("bee-work");
